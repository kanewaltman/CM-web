...
/**
 * Renders a control bar for managing the dashboard grid layout.
 *
 * This component provides controls to copy, paste, and reset the grid layout; it also offers an interface
 * for editing appearance settings such as theme and grid style. It updates CSS variables, interacts with
 * GridStack instances for layout adjustments, and persists grid style preferences in local storage.
 *
 * @param onResetLayout Callback invoked to reset the grid layout.
 * @param onCopyLayout Callback invoked to retrieve the current layout configuration.
 * @param onPasteLayout Callback invoked to apply a new layout configuration.
 */
