...
// Custom implementation of Fingerprint icon to avoid ad blockers
...
export const AuthIcon = SecurityIcon;
export const Fingerprint = SecurityIcon;

// Export all other lucide icons you need directly from this file
// This way you have a central place to manage icons and avoid ad blocker issues 